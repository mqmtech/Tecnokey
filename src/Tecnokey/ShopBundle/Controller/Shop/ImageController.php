...
use Tecnokey\ShopBundle\Form\Shop\ImageType;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TecnokeyShopBundle:Shop\Image')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TecnokeyShopBundle:Shop\Image')->find($id);
     ...
     * @Method("post")
     * @Template("TecnokeyShopBundle:Shop\Image:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("TecnokeyShopBundle:Shop\Image:edit.html.twig")
     */
