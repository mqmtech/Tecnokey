    ...
    public function createAction()
    {
        ...
        try{
            if ($form->isValid()) {
                ...
                $validation = $this->validateEmail($entity);
                if($validation == false){
                    throw new Exception("Custom Exception: Email is not the same");
                }
                $validation = $this->validatePassword($entity);
                if($validation == false){
                    throw new Exception("Custom Exception: Password is not the same");
                }
            ...
            $this->get('session')->setFlash('database_error',"Atencion: el correo electronico ya existe en nuestra base de datos");
            return $this->redirect($this->generateUrl('TKShopFrontendUserNew'));
        }
